            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-12 d-sm-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.news.faqs.create', $news->id) }}" class="btn btn-success rounded-pill">Thêm
                            mới</a>
                                    ...
                                    @forelse ($faqs as $faq)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.news.faqs.destroy', [$news->id, $faq->id]) }}"
                                     ...
                                     @empty
                                        <tr>
                                            <td colspan="4" class="text-center text-muted">Không có dữ liệu câu hỏi tin tức.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
