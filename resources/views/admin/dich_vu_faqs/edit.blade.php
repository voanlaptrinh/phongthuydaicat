        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.dichvu.faqs.update', [$dichvu->id, $faq->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
...
<div class="text-end mt-4">
                        ...
                        <a href="{{ route('admin.dichvu.faqs.index', $dichvu->id) }}" class="btn btn-secondary">Quay lại</a>
</div>
                    </form>
                </div>
            </div>
