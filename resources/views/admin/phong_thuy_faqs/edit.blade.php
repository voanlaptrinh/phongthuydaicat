        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.phongthuy.faqs.update', [$phongThuy->id, $faq->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
...
<div class="text-end mt-4">
                        ...
                        <a href="{{ route('admin.phongthuy.faqs.index', $phongThuy->id) }}" class="btn btn-secondary">Quay lại</a>
</div>
                    </form>
                </div>
            </div>
